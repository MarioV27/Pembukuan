        ...
        <div class="col-lg">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="/Pemasukan/edit/{{$data->id}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="productSelect" name="nama_produk" >
                ...
                <script>
                  const selectedProductId = <?php echo json_encode($data->nama_produk)?>; 
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Penambahan</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="penambahan" value="{{$data->penambahan}}">
                  </div>
                </div>
                <fieldset class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="status" <?= $data->status === 'piutang' ? 'checked' : '' ?> id="gridRadios1" value="piutang" onchange="togglePiutangInput()">
                      <label class="form-check-label" for="gridRadios1">
                        Piutang
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="status" <?= $data->status === 'lunas' ? 'checked' : '' ?> id="gridRadios2" value="lunas" onchange="togglePiutangInput()">
