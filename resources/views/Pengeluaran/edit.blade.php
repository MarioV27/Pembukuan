        ...
        <div class="col-lg">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="/Pengeluaran/edit/{{$data->id}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="productSelect" name="kategori">
                ...
                <script>
                  const selectedProductId = <?php echo json_encode($data->kategori)?>; 
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" id="productSelect1" name="supplier">
                ...
                <script>
                  const selectedProductIds = <?php echo json_encode($data->supplier)?>; 
                  const selectElements = document.getElementById('productSelect1');
                  selectElements.value = selectedProductIds; 
                </script>
                ...
                <fieldset class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="status" name="status" <?= $data->status === 'piutang' ? 'checked' : '' ?> id="gridRadios1" value="piutang" onchange="togglePiutangInput()">
                      <label class="form-check-label" for="gridRadios1">
                        Piutang
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="status" name="status" <?= $data->status === 'lunas' ? 'checked' : '' ?> id="gridRadios2" value="lunas" onchange="togglePiutangInput()">
